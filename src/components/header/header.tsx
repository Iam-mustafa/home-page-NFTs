    ...
    <header className="w-full bg-transparent py-5 sticky top-0 z-50">
      <div className="container mx-auto w-full px-2 md:px-12">
        <div className="flex items-center justify-between">
          ...
          {/* Sign Up Button */}
          <button className="flex justify-center items-center space-x-3 self-stretch bg-gradient-to-r from-[#A259FF] to-[#377DF7] hover:from-transparent hover:to-transparent border-[#A259FF] border-2 text-white px-3 py-2 md:px-8 md:py-3 rounded-full transition-colors">
            <Gamepad2 className="w-5 h-5" />
            <span>Player Login</span>
          </button>
          <button className="flex justify-center items-center space-x-2 self-stretch bg-gradient-to-r from-[#A259FF] to-[#377DF7] hover:from-transparent hover:to-transparent border-[#A259FF] border-2 text-white px-3 py-2 md:px-8 md:py-3 rounded-full transition-colors">
